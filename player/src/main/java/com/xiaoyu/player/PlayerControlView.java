...
public class PlayerControlView extends FrameLayout {
    ...
    private OnClickListener fullScreenOnClickListener;
    ...
    public PlayerControlView(
        ...
        fullscreenView.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                if (fullScreenOnClickListener != null) {
                    fullScreenOnClickListener.onClick(view);
                }
                if (getResources().getConfiguration().orientation == Configuration.ORIENTATION_LANDSCAPE) {
                    ((Activity) getContext()).setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_PORTRAIT);
                    fullscreenView.setImageResource(R.mipmap.video_shrink);
                } else {
                    ((Activity) getContext()).setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_LANDSCAPE);
                    fullscreenView.setImageResource(R.mipmap.video_enlarge);
                }
            }
        });
    ...
    public void setFullScreenOnClickListener(OnClickListener listener) {
        fullScreenOnClickListener = listener;
    }
